...
from src.integrations.multi_agent_coder_client import MultiAgentCoderClient, MultiAgentStrategy
...
def test_analyze_real_github_issue():
    ...
    multi_agent_path = Path(__file__).parent.parent.parent.parent / "multi_agent_coder" / "multi_agent_coder"
