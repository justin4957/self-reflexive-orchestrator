...
🤖 Generated by [Self-Reflexive Orchestrator](https://github.com/justin4957/self-reflexive-orchestrator)
"""
    ...
    def _format_test_results(self, test_result: Optional[TestResult]) -> str:
        ...
        """
        if not test_result:
            return "⏭️ Tests not run yet"

        if test_result.success:
            return f"✅ All tests passing ({test_result.passed} passed, {test_result.failed} failed, {test_result.skipped} skipped)"
        ...
        return f"❌ Tests failing ({test_result.passed} passed, {test_result.failed} failed){failures_text}"
